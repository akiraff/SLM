...
xlocs_arr = xcoor[8:18:2]  # 17 is not included
ylocs = int(ycoor[6])
...
xlocs_arr = xcoor[7:19:2]  # 17 is not included
ylocs = int(ycoor[7])
...
xlocs_arr = xcoor[7:19:2]  # 17 is not included
ylocs = int(ycoor[15])
resRow12 = CreateResRow(xlocs_arr, ylocs)

xlocs_arr = xcoor[7:19:2]  # 17 is not included
ylocs = int(ycoor[17])
resRow13 = CreateResRow(xlocs_arr, ylocs)

res_arr = np.concatenate((resRow1, resRow2, resRow3, resRow4, resRow5, resRow6, resRow7, resRow8, resRow9, resRow10, resRow11, resRow12, resRow13), axis=0)
