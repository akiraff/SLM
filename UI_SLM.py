...
#
# WARNING: Initial file generated by PyQt5 UI code, modified heavily by Fang
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Button_calculate.setGeometry(QtCore.QRect(290, 340, 150, 28))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setBold(True)
        font.setWeight(75)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.Button_calculateAdapt.setFont(font)
        self.Button_calculateAdapt.setObjectName("Button_calculateAdapt")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Button_calculate.setStatusTip(_translate("MainWindow", "Calculate the SLM phase with uniform WGS and you can choose to save it in a csv file."))
        self.Button_calculate.setText(_translate("MainWindow", "Calculate (Uniform)"))
        self.Button_calculateAdapt.setStatusTip(_translate("MainWindow",
                                                      "Calculate the SLM phase with adapted WGS and you can choose to save it in a csv file."))
        self.Button_calculateAdapt.setText(_translate("MainWindow", "Calculate (Adapted)"))
        ...
        self.label_14.setText(_translate("MainWindow", "Aperture radius (mm)"))
    ...
    def calculateAdapt(self):
        ...
        if self.threshold.text() == "":
            ...
            gaussianAmp, gaussianPhase = myIMG.initSLMImage(mask=mask, Plot=False)
            if lattice == "Rec":
                Focalpitchx, Focalpitchy, targetAmp, location = myIMG.initFocalImage_RecLattice(distance,
                                                                                            [spacingx, spacingy],
                                                                                            [arraysizex, arraysizey],
                                                                                            Plot=False)
            elif lattice == "Kagome":
