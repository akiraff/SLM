...
if __name__ == '__main__':
    ...
    SLM_screen_WGS = SLM_screen_WGS_aberr
   #LS = LoadAndSave()
    # Load SLM aberration config file
    file_name = 'aberrationCorr/SLM_aberr_config_rec.npy'
    ...
    # Add aberration correction file for the ring
    SLM_screen_WGS = SLM_screen_WGS_aberr
    # Method 1, add all aberration correction Zernikes together first
    file_name = 'aberrationCorr/SLM_aberr_config_ring.npy'
    aberrConfigzind = np.load(file_name, allow_pickle=True).item()
    ind_Zernike_list = list(aberrConfigzind.keys())
    percent_list = list(aberrConfigzind.values())
    SLM_aberr_screen_sum = 0
    ...
    SLM_screen_WGS_aberr_m1 = SLM_screen_WGS_aberr
    # Method 2,add them one by one and then normalize
    file_name = 'aberrationCorr/SLM_aberr_config_ring.npy'
    aberrConfigzind = np.load(file_name, allow_pickle=True).item()
    ind_Zernike_list = list(aberrConfigzind.keys())
    percent_list = list(aberrConfigzind.values())
    ...
    SLM_screen_WGS_aberr_m2 = SLM_screen_WGS
    print((SLM_screen_WGS_aberr_m1 == SLM_screen_WGS_aberr_m2).all())
