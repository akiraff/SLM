...
# Create reservoir atoms inside the ring
xlocs = int(xcoor[20])
ylocs_arr = ycoor[8:20:2] # 20 is not included
resCol1 = CreateResCol(xlocs, ylocs_arr)
print("xcoor size:", np.size(xcoor))
print("xcoor:", xcoor)
print("ycoor size:", np.size(ycoor))
print("ycoor:", ycoor)

xlocs = int(xcoor[19])
ylocs_arr = ycoor[np.r_[7:19:2,21]]
resCol2 = CreateResCol(xlocs, ylocs_arr)
#print("resCol2", resCol2)

xlocs = int(xcoor[18])
ylocs_arr = ycoor[np.r_[8:18:2, 20]]
resCol3 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[17])
ylocs_arr = ycoor[np.r_[7:17:2, 19:23:2]]
resCol4 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[16])
ylocs_arr = ycoor[np.r_[8:16:2, 18:22:2]]
resCol5 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[15])
ylocs_arr = ycoor[np.r_[7:15:2, 17:23:2]]
resCol6 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[14])
ylocs_arr = ycoor[np.r_[8:14:2, 16:22:2]]
resCol7 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[13])
ylocs_arr = ycoor[np.r_[7:13:2, 15:23:2]]
resCol8 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[12])
ylocs_arr = ycoor[np.r_[8:12:2, 14:22:2]]
resCol9 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[11])
ylocs_arr = ycoor[np.r_[7:11:2, 13:23:2]]
resCol10 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[10])
ylocs_arr = ycoor[np.r_[8, 12:22:2]]
resCol11 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[9])
ylocs_arr = ycoor[np.r_[7, 11:23:2]]
resCol12 = CreateResCol(xlocs, ylocs_arr)

xlocs = int(xcoor[8])
ylocs_arr = ycoor[np.r_[10:22:2]]
resCol13 = CreateResCol(xlocs, ylocs_arr)

res_arr = np.concatenate((resCol1, resCol2, resCol3, resCol4, resCol5, resCol6, resCol7, resCol8, resCol9, resCol10, resCol11, resCol12, resCol13), axis=0)
...
target_arr = np.concatenate((ringcoor_arr, res_arr),axis=0)
